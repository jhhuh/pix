...
class TestStageXgcc:
    ...
    def test_mpfr_drv_path(self):
        assert StageXgcc().mpfr.drv_path == EXPECTED_STAGE_XGCC["mpfr.drv"]

    def test_mpfr_out_path(self):
        assert StageXgcc().mpfr.out == EXPECTED_STAGE_XGCC["mpfr.out"]

    def test_isl_drv_path(self):
        assert StageXgcc().isl.drv_path == EXPECTED_STAGE_XGCC["isl.drv"]
    ...
    def test_libxcrypt_drv_path(self):
        assert StageXgcc().libxcrypt.drv_path == EXPECTED_STAGE_XGCC["libxcrypt.drv"]
